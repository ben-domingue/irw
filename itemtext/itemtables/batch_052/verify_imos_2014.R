# verify_imos_2014.R -- Step 5b evidence for imos_2014 (55th IMO, Cape Town, South Africa).
#
# THE CLAIM: item `problemK` in the IRW table is the problem printed as
# "Problem K" in the official IMO 2014 problem paper
# (https://www.imo-official.org/assets/documents/problems/2014/2014_eng.pdf).
# The 2014 paper prints the numbers 1-6 outright (day 1 = Problems 1-3,
# Tuesday 8 July; day 2 = Problems 4-6, Wednesday 9 July), so no day-numbering
# convention had to be inferred.
#
# WHY THIS IS FALSIFIABLE: the same organisation that publishes the numbered
# problem statements also publishes the per-contestant marks for 2014 under the
# column headings P1..P6 (https://www.imo-official.org/results/individual/year/2014/,
# embedded JSON "scores":[P1..P6], 560 contestants). If IRW's problem1..problem6
...
# are pairwise distinct, which this script also checks, so the assignment is
# unique rather than merely consistent.
#
# Hard-coded below: the official 2014 individual-results page, scraped
# 2026-09-07, 560 contestants, counts of each mark 0..7 per problem.
...
OFFICIAL <- matrix(c(
  75,  23,  14,  22,  15,  18,  23, 370,   # P1
 240,  32,  25,  17,  14,  39,  71, 122,   # P2
 479,  43,   1,   2,   3,   0,   4,  28,   # P3
  24, 103,  28,  16,   5,   3,   3, 378,   # P4
 301,  60,  83,  10,   8,   3,  11,  84,   # P5
 514,   7,   7,  11,   0,   5,   1,  15),  # P6
 nrow = 6, byrow = TRUE,
...
cat("Official imo-official.org P1..P6 mark counts (0..7), 560 contestants:\n")
print(OFFICIAL)
cat("\nLive irw_fetch('imos_2014') problem1..problem6 resp counts (0..7):\n")
print(live)
...
# Independent structural fingerprint: exactly two cells are empty, on different
# problems AND different marks -- P3 has zero marks of 5, P6 zero marks of 4.
