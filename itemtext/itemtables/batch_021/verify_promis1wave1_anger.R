## verify_promis1wave1_anger.R  --  batch_021, issue #1831
##
...
##
## Run from itemtext/:
##   Rscript itemtables/batch_021/verify_promis1wave1_anger.R
##   Rscript itemtables/batch_021/verify_promis1wave1_anger.R --resp-csv <path>
source("itemtables/batch_021/verify_common.R")
verify_table("promis1wave1_anger", verify_args())
