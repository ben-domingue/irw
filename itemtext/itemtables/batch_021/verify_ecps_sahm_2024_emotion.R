## verify_ecps_sahm_2024_emotion.R  --  batch_021, issue #1831
##
...
##
## Run from itemtext/:
##   Rscript itemtables/batch_021/verify_ecps_sahm_2024_emotion.R
##   Rscript itemtables/batch_021/verify_ecps_sahm_2024_emotion.R --resp-csv <path>
source("itemtables/batch_021/verify_ecps_common.R")
verify_ecps("ecps_sahm_2024_emotion", verify_args())
