## verify_promis1wave1_pain.R  --  batch_016, issue #1831
##
...
##
## Run from itemtext/:
##   Rscript itemtables/batch_016/verify_promis1wave1_pain.R
##   Rscript itemtables/batch_016/verify_promis1wave1_pain.R --resp-csv <path>
source("itemtables/batch_016/verify_common.R")
verify_table("promis1wave1_pain", verify_args())
