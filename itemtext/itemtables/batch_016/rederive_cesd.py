#!/usr/bin/env python3
"""rederive_cesd.py -- batch_016, issue #1831
...
Writes  itemtables/batch_016/rederived_cesd.json
Run from itemtext/:  python3 itemtables/batch_016/rederive_cesd.py
"""
import json, os, re, sys

SRC   = ".cache/promis1wave1/codebook.txt"
OUT   = "itemtables/batch_016/rederived_cesd.json"
