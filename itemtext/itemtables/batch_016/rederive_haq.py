#!/usr/bin/env python3
"""rederive_haq.py -- batch_016, issue #1831
...
Writes  itemtables/batch_016/rederived_haq.json
Run from itemtext/:  python3 itemtables/batch_016/rederive_haq.py
"""
import json, os, re, sys

SRC = ".cache/promis1wave1/codebook.txt"
OUT = "itemtables/batch_016/rederived_haq.json"
