## verify_COACH_Chen_2022_ADL.R  --  batch_016, issue #1831
##
...
##
## Run from itemtext/:
##   Rscript itemtables/batch_016/verify_COACH_Chen_2022_ADL.R
##   Rscript itemtables/batch_016/verify_COACH_Chen_2022_ADL.R --resp-csv <path>
source("itemtables/batch_016/verify_coach_common.R")
verify_coach("COACH_Chen_2022_ADL", verify_args())
