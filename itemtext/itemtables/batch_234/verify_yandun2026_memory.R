# verify_yandun2026_memory.R
#
# CLAIM UNDER TEST: data/yandun2026_cognitive.py assigns the item codes
# mem1..mem5 POSITIONALLY to columns 10..14 (1-based) of each sheet of
...
COLS  <- 10:14          # 1-based source columns for the Memory block
ITEMS <- paste0("mem", 1:5)
