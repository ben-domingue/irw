## verify_kushnir2017_anrt.R  --  batch_015, issue #1774
##
...
##
## Run from itemtext/:  Rscript itemtables/batch_015/verify_kushnir2017_anrt.R
suppressMessages({library(jsonlite); library(irw)})
TBL <- "kushnir2017_anrt"
CSV <- "itemtables/batch_015/kushnir2017_anrt__items.csv"
