## verify_balmas2018_leader_attitudes.R  --  batch_015, issue #1774
##
...
##
## Run from itemtext/:  Rscript itemtables/batch_015/verify_balmas2018_leader_attitudes.R
suppressMessages({library(jsonlite); library(irw)})
TBL <- "balmas2018_leader_attitudes"
CSV <- "itemtables/batch_015/balmas2018_leader_attitudes__items.csv"
