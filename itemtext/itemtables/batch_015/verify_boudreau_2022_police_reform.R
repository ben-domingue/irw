## verify_boudreau_2022_police_reform.R  --  batch_015, issue #1774
##
...
##
## Run from itemtext/:  Rscript itemtables/batch_015/verify_boudreau_2022_police_reform.R
suppressMessages({library(jsonlite); library(irw)})
TBL <- "boudreau_2022_police_reform"
CSV <- "itemtables/batch_015/boudreau_2022_police_reform__items.csv"
