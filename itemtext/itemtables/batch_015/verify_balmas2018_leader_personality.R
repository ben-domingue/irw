## verify_balmas2018_leader_personality.R  --  batch_015, issue #1774
##
...
##
## Run from itemtext/:  Rscript itemtables/batch_015/verify_balmas2018_leader_personality.R
suppressMessages({library(jsonlite); library(irw)})
TBL <- "balmas2018_leader_personality"
CSV <- "itemtables/batch_015/balmas2018_leader_personality__items.csv"
