## verify_Adherence_Zissette_2018_SDB.R  --  batch_015, issue #1774
##
...
##
## Run from itemtext/:  Rscript itemtables/batch_015/verify_Adherence_Zissette_2018_SDB.R
suppressMessages({library(jsonlite); library(irw)})
TBL <- "Adherence_Zissette_2018_SDB"
CSV <- "itemtables/batch_015/Adherence_Zissette_2018_SDB__items.csv"
