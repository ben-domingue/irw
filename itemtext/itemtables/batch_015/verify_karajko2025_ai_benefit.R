## verify_karajko2025_ai_benefit.R  --  batch_015, issue #1774
##
...
##
## Run from itemtext/:  Rscript itemtables/batch_015/verify_karajko2025_ai_benefit.R
suppressMessages({library(jsonlite); library(irw)})
TBL <- "karajko2025_ai_benefit"
CSV <- "itemtables/batch_015/karajko2025_ai_benefit__items.csv"
