...
batch, so the build can be reproduced exactly:
    ...
    python3 42_rebuild.py --year 2016
    python3 31_assemble_batch.py --year 2016
...
| 26_strip_page_furniture.py | 26_strip_page_furniture.v9.py | `db1db42b207ffe54783ca157b486022e` |
...
| 48_mark_scripts.py | 48_mark_scripts.v5.py | `adf0654bb3fd576c4e4e18420ae8ff79` |
