## verify_promis1wave1_depression.R  --  batch_022, issue #1831
##
...
##
## Run from itemtext/:
##   Rscript itemtables/batch_022/verify_promis1wave1_depression.R
##   Rscript itemtables/batch_022/verify_promis1wave1_depression.R --resp-csv <path>
source("itemtables/batch_022/verify_common.R")
verify_table("promis1wave1_depression", verify_args())
