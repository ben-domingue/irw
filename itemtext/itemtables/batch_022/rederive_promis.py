#!/usr/bin/env python3
"""rederive_promis.py -- batch_022, issue #1831
...
Writes  itemtables/batch_022/rederived.json
Run from itemtext/:  python3 itemtables/batch_022/rederive_promis.py
"""
import json, os, re, sys

CACHE = ".cache/promis1wave1"
OUT   = "itemtables/batch_022/rederived.json"
