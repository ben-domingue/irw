## verify_ecps_sahm_2024_dtl.R  --  batch_022, issue #1831
##
...
##
## Run from itemtext/:
##   Rscript itemtables/batch_022/verify_ecps_sahm_2024_dtl.R
##   Rscript itemtables/batch_022/verify_ecps_sahm_2024_dtl.R --resp-csv <path>
