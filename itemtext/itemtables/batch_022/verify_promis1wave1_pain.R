## verify_promis1wave1_pain.R  --  batch_022, issue #1831
##
...
##
## Run from itemtext/:
##   Rscript itemtables/batch_022/verify_promis1wave1_pain.R
##   Rscript itemtables/batch_022/verify_promis1wave1_pain.R --resp-csv <path>
