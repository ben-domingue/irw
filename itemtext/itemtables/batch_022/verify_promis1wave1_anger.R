## verify_promis1wave1_anger.R  --  batch_022, issue #1831
##
...
##
## Run from itemtext/:
##   Rscript itemtables/batch_022/verify_promis1wave1_anger.R
##   Rscript itemtables/batch_022/verify_promis1wave1_anger.R --resp-csv <path>
