# batch_196 quarantine

`tsai_2017_treeit_h9_error` — extracted and gated clean (audit_batch PASS, verify_batch PASS, lint clean,
...
or a grant covering them. The provenance and notes rows in `itemtables/batch_196/` carry
