# batch_195 quarantine

`tsai_2017_treeit_h5_memory`, `tsai_2017_treeit_h6_feedback`, `tsai_2017_treeit_h7_flexibility` — extracted and gated clean (audit_batch PASS, verify_batch PASS, lint clean,
...
or a grant covering them. The provenance and notes rows in `itemtables/batch_195/` carry
