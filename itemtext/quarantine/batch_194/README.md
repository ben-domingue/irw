# batch_194 quarantine

`tsai_2017_treeit_h2_visibility`, `tsai_2017_treeit_h3_match`, `tsai_2017_treeit_h4_minimalist` — extracted and gated clean (audit_batch PASS, verify_batch PASS, lint clean,
...
or a grant covering them. The provenance and notes rows in `itemtables/batch_194/` carry
