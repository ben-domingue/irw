# batch_192 quarantine

`tsai_2017_treeit_h10_closure`, `tsai_2017_treeit_h11_undo`, `tsai_2017_treeit_h12_language` — extracted and gated clean (audit_batch PASS, verify_batch PASS, lint clean,
...
or a grant covering them. The provenance and notes rows in `itemtables/batch_192/` carry
