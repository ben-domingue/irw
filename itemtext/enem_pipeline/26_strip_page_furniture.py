...
ANYWHERE = [
    ...
    # 2025 leaks the same thing with the newer .indd extension, and doubles it
    # ("...indd   6P1_2_...indd   6 25/07/2025   08:49:1225/07/2025   08:49:12"),
    # exactly the way that year's booklets double an option letter. Matching
    # only .indb left it in one 2025 CN option, behind a formula.
    re.compile(r"^.*\.ind[bd]\s+\d+\s+\d{2}/\d{2}/\d{4}\s+\d{2}:\d{2}:\d{2}.*$", re.I),
