...
master <- read_delim('algebra_2005_2006_master.txt')

train <- read_delim('algebra_2005_2006_train.txt')

test <- read_delim('algebra_2005_2006_test.txt')
...
save(df, file="cmu_algebra_2006.Rdata")
