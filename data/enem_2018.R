# ENEM 2018 -> IRW long format (id | item | resp | position | booklet),
...
# this year's INEP dictionary (Dicionario_Microdados_Enem_2018.xlsx) by
...
year <- 2018
standard_prova_codes <- c(447, 448, 449, 450, 451, 452, 453, 454, 455, 456, 457, 458, 459, 460, 461, 462)
regular_prova_codes  <- c(447, 448, 449, 450, 451, 452, 453, 454, 455, 456, 457, 458, 459, 460, 461, 462, 463, 464, 465, 466, 467, 468, 469, 470)
