...
microdata <- vroom('DADOS/MICRODADOS_ENEM_2018.csv', 
                   delim=';', 
...
items <- vroom('DADOS/ITENS_PROVA_2018.csv', 
               delim=';',
...
save(df, file='enem_2018_1mil_lc.Rdata')
...
save(df, file='enem_2018_1mil_ch.Rdata')
...
save(df, file='enem_2018_1mil_cn.Rdata')
...
save(df, file='enem_2018_1mil_mt.Rdata')
