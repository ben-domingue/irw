"""Student questionnaire used for a Rasch gender-differential analysis.

DOI: 10.17632/4sn3936svj
Source: https://data.mendeley.com/datasets/4sn3936svj
License: CC BY 4.0
Contributor (deposit record): Erguvan

478 respondents, 25 five-point Likert items (Q1-Q25), with gender, major
and year of study as covariates.
"""
...
DOI = "10.17632/4sn3936svj"
KEY = "4sn3936svj"
FILENAME = 'Questionnaire - Revised additional data.xlsx'
READ_KW = {}
UA = {"User-Agent": "irw-batch/1.0 (research)"}

TABLE_PREFIX = "erguvan_2022_"
BLOCKS = {'questionnaire': 'Q\\d+'}            # table suffix -> regex matching its item columns
COVS = {'Gender': 'cov_gender', 'Major': 'cov_major', 'Year': 'cov_year_of_study'}
DROP = []
DROP_REASON = ''
SCALE = {'questionnaire': (1, 5)}              # table suffix -> (min, max), or None to infer
QC_WAIVERS = {}
