# ENEM 2017 -> IRW long format (id | item | resp | position | booklet),
...
# this year's INEP dictionary (Dicionario_Microdados_Enem_2017.xlsx) by
...
year <- 2017
standard_prova_codes <- c(391, 392, 393, 394, 395, 396, 397, 398, 399, 400, 401, 402, 403, 404, 405, 406)
regular_prova_codes  <- c(391, 392, 393, 394, 395, 396, 397, 398, 399, 400, 401, 402, 403, 404, 405, 406, 407, 408, 409, 410, 411, 412, 413, 414)
