"""Academic motivation and learning strategies (81-item MSLQ-form instrument), Mexican university students.

DOI: 10.17632/bsxgbt8wnp
Source: https://data.mendeley.com/datasets/bsxgbt8wnp
License: CC BY 4.0
Contributor (deposit record): Fraijo, Norzagaray

347 respondents, 81 items (item1-item81) on a single 1-7 scale --
the MSLQ item count. The deposit does not publish a subscale map, so
the administration ships as one table rather than inventing a split.
"""
...
DOI = "10.17632/bsxgbt8wnp"
KEY = "bsxgbt8wnp"
FILENAME = 'Data_Fraijo_Norzagaray_2022.xlsx'
READ_KW = {}
UA = {"User-Agent": "irw-batch/1.0 (research)"}

TABLE_PREFIX = "fraijo_2022_"
BLOCKS = {'mslq': 'item\\d+'}            # table suffix -> regex matching its item columns
COVS = {'Age': 'cov_age', 'Gender': 'cov_gender', 'University year': 'cov_university_year', 'Shift': 'cov_shift', 'Student’s Residence': 'cov_residence'}
DROP = []
DROP_REASON = ''
SCALE = {'mslq': (1, 7)}              # table suffix -> (min, max), or None to infer
QC_WAIVERS = {}
