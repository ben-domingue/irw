# ENEM 2020 -> IRW long format (id | item | resp | position | booklet),
...
# this year's INEP dictionary (Dicionario_Microdados_Enem_2020.xlsx) by
...
year <- 2020
standard_prova_codes <- c(567, 568, 569, 570, 577, 578, 579, 580, 587, 588, 589, 590, 597, 598, 599, 600)
regular_prova_codes  <- c(567, 568, 569, 570, 571, 572, 574, 575, 577, 578, 579, 580, 581, 582, 584, 585, 587, 588, 589, 590, 591, 592, 594, 595, 597, 598, 599, 600, 601, 602, 604, 605)
