...
# section, "perceived level of preparation" was measured with 2 raw items
# on a less/as/more-prepared-than-peers scale (1-3): perceived
# preparedness for first-semester graduate technical coursework
# (prepared1) and for advanced undergraduate technical coursework
# (prepared2). Shipped as its own 2-item table. Companion scales from the
# same survey/sample: fisher_2019_belonging (2 items) and
# fisher_2019_structure (2 items).
...
def convert():
    ...
    fname = "fisher_2019_preparedness.csv"
