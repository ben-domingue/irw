...
# section, "sense of belonging" was measured with 2 raw items: "when I am
# in a STEM setting I feel accepted" (accepted) and "... I feel
# insignificant" (insignificant, reverse-worded). Shipped as its own
# 2-item table. Companion scales from the same survey/sample:
# fisher_2019_structure (2 items) and fisher_2019_preparedness (2 items).
# Single-item measures (distress, pub) and binary program-milestone
# indicators (courses/quals/prelims/masters/abd/dissertation -- these are
# institutional progress records, not survey items of a measure) excluded
# per pipeline rules. "success" is not documented as a raw survey item in
# the Measures section and was excluded as ambiguous.
...
ITEM_COLS = ["accepted", "insignificant"]
...
def convert():
    ...
    fname = "fisher_2019_belonging.csv"
