"""Digital burnout and social-media use among Vietnamese respondents.

DOI: 10.17632/htwjk32j59
Source: https://data.mendeley.com/datasets/htwjk32j59
License: CC BY 4.0
Contributor (deposit record): Pham

456 respondents. Seven five-point Likert blocks ship as their own
tables (THBT, BSGT, BSYN, BSTH, KTSLH, KTSTH, KTSCX), plus GP1-GP6,
a separate binary 0/1 block kept apart from the Likert blocks rather
than pooled with them.

The twelve tb* columns are subscale means (their values are fractional)
and are dropped. The single-item measures CAMXUC, STRESS, TSMXH,
TANSUATDANGBAI, FOLLOWER and TUONGTAC are kept as covariates -- a
one-item measure is never shipped as its own table.
"""
...
DOI = "10.17632/htwjk32j59"
KEY = "htwjk32j59"
FILENAME = 'DATA SPSS - FINAL.sav'
READ_KW = {}
UA = {"User-Agent": "irw-batch/1.0 (research)"}

TABLE_PREFIX = "pham_2026_"
BLOCKS = {'thbt': 'THBT\\d+', 'bsgt': 'BSGT\\d+', 'bsyn': 'BSYN\\d+', 'bsth': 'BSTH\\d+', 'ktslh': 'KTSLH\\d+', 'ktsth': 'KTSTH\\d+', 'ktscx': 'KTSCX\\d+', 'gp': 'GP\\d+'}            # table suffix -> regex matching its item columns
COVS = {'TUOI': 'cov_age_band', 'GIOITINH': 'cov_gender', 'TÌNHTRANGCONGVIEC': 'cov_employment_status', 'NGANHHOC': 'cov_major', 'LINHVUCLAM': 'cov_work_field', 'TANSUATDANGBAI': 'cov_posting_frequency', 'FOLLOWER': 'cov_follower_count', 'CAMXUC': 'cov_emotion_single_item', 'STRESS': 'cov_stress_single_item', 'TƯƠNGTAC': 'cov_interaction', 'TSMXH': 'cov_social_media_frequency'}
DROP = ['tbLHKTS', 'tbTHKTS', 'tbCXKTS', 'tbKSKTS', 'tbTHBT', 'tbBSGT', 'tbBSYN', 'tbBSTH', 'tbDDBS', 'tbTHBTa', 'tbDDBSa', 'tbKSKTSa']
DROP_REASON = 'subscale mean (fractional values), not a raw item'
SCALE = {'thbt': (1, 5), 'bsgt': (1, 5), 'bsyn': (1, 5), 'bsth': (1, 5), 'ktslh': (1, 5), 'ktsth': (1, 5), 'ktscx': (1, 5), 'gp': (0, 1)}              # table suffix -> (min, max), or None to infer
QC_WAIVERS = {}
