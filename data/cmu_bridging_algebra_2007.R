...
master <- read_delim('bridge_to_algebra_2006_2007_master.txt')

train <- read_delim('bridge_to_algebra_2006_2007_train.txt')

test <- read_delim('bridge_to_algebra_2006_2007_test.txt')
...
save(df, file="cmu_bridging_algebra_2007.Rdata")
