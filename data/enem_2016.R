# ENEM 2016 -> IRW long format (id | item | resp | position | booklet),
...
# this year's INEP dictionary (Dicionario_Microdados_Enem_2016.xlsx) by
...
year <- 2016
standard_prova_codes <- c(291, 292, 293, 294, 295, 296, 297, 298, 299, 300, 301, 302, 303, 304, 305, 306)
regular_prova_codes  <- c(291, 292, 293, 294, 295, 296, 297, 298, 299, 300, 301, 302, 303, 304, 305, 306, 307, 308, 309, 310, 344)
