...
save(maia_df, file="SV-MAIA2_Ranđelović_2021_MAIA.Rdata")
write.csv(maia_df, "SV-MAIA2_Ranđelović_2021_MAIA.csv", row.names=FALSE)
...
save(SHS_df, file="SV-MAIA2_Ranđelović_2021_SHS.Rdata")
write.csv(SHS_df, "SV-MAIA2_Ranđelović_2021_SHS.csv", row.names=FALSE)
...
save(student_hexaco_df, file="SV-MAIA2_Ranđelović_2021_hexaco100.Rdata")
write.csv(student_hexaco_df, "SV-MAIA2_Ranđelović_2021_hexaco100.csv", row.names=FALSE)
...
save(student_delta_df, file="SV-MAIA2_Ranđelović_2021_delta.Rdata")
write.csv(student_delta_df, "SV-MAIA2_Ranđelović_2021_delta.csv", row.names=FALSE)
...
save(student_GEI_df, file="SV-MAIA2_Ranđelović_2021_GEI.Rdata")
write.csv(student_GEI_df, "SV-MAIA2_Ranđelović_2021_GEI.csv", row.names=FALSE)
...
save(student_SOD_df, file="SV-MAIA2_Ranđelović_2021_SOD.Rdata")
write.csv(student_SOD_df, "SV-MAIA2_Ranđelović_2021_SOD.csv", row.names=FALSE)
...
save(student_PD_df, file="SV-MAIA2_Ranđelović_2021_PD.Rdata")
write.csv(student_PD_df, "SV-MAIA2_Ranđelović_2021_PD.csv", row.names=FALSE)
...
save(student_FA_df, file="SV-MAIA2_Ranđelović_2021_FA.Rdata")
write.csv(student_FA_df, "SV-MAIA2_Ranđelović_2021_FA.csv", row.names=FALSE)
...
save(student_EA_df, file="SV-MAIA2_Ranđelović_2021_EA.Rdata")
write.csv(student_EA_df, "SV-MAIA2_Ranđelović_2021_EA.csv", row.names=FALSE)
...
save(student_SA_df, file="SV-MAIA2_Ranđelović_2021_SA.Rdata")
write.csv(student_SA_df, "SV-MAIA2_Ranđelović_2021_SA.csv", row.names=FALSE)
...
save(student_MT_df, file="SV-MAIA2_Ranđelović_2021_MT.Rdata")
write.csv(student_MT_df, "SV-MAIA2_Ranđelović_2021_MT.csv", row.names=FALSE)
...
save(student_M_df, file="SV-MAIA2_Ranđelović_2021_M.Rdata")
write.csv(student_M_df, "SV-MAIA2_Ranđelović_2021_M.csv", row.names=FALSE)
...
save(student_P_df, file="SV-MAIA2_Ranđelović_2021_P.Rdata")
write.csv(student_P_df, "SV-MAIA2_Ranđelović_2021_P.csv", row.names=FALSE)
...
save(practioner_hexaco_df, file="SV-MAIA2_Ranđelović_2021_hexaco60.Rdata")
write.csv(practioner_hexaco_df, "SV-MAIA2_Ranđelović_2021_hexaco60.csv", row.names=FALSE)
...
save(practioner_DEL20_df, file="SV-MAIA2_Ranđelović_2021_DEL20.Rdata")
write.csv(practioner_DEL20_df, "SV-MAIA2_Ranđelović_2021_DEL20.csv", row.names=FALSE)
...
save(practioner_ERQ_df, file="SV-MAIA2_Ranđelović_2021_ERQ.Rdata")
write.csv(practioner_ERQ_df, "SV-MAIA2_Ranđelović_2021_ERQ.csv", row.names=FALSE)
...
save(practioner_dass_df, file="SV-MAIA2_Ranđelović_2021_DASS.Rdata")
write.csv(practioner_dass_df, "SV-MAIA2_Ranđelović_2021_DASS.csv", row.names=FALSE)
