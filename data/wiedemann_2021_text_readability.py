...
# and risk protection". S1 Dataset (.s007, SAV). CC BY 4.0. N=344.
# Second distinct instrument block in the file (see also
# wiedemann_2021_risk_perception.py): F11-F16, a 6-item semantic-
# differential rating of text readability/comprehensibility (e.g. "leicht
# verständlich - schwer verständlich" = "easy to understand - hard to
# understand"), each a 7-point bipolar scale.
URL = ("https://journals.plos.org/plosone/article/file"
       "?type=supplementary&id=10.1371/journal.pone.0253762.s007")
UA = {"User-Agent": "IRW-Finder/1.0 (ben.domingue@gmail.com)"}

ITEM_COLS = ["F11", "F12", "F13", "F14", "F15", "F16"]
COV_COLS = {
...
def convert():
    ...
    long.to_csv(OUT_DIR / "wiedemann_2021_text_readability.csv", index=False)
