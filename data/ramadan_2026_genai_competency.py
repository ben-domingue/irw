"""Generative-AI competency of Arabic language and literature students.

DOI: 10.17632/xd27t4g547
Source: https://data.mendeley.com/datasets/xd27t4g547
License: CC BY 4.0
Contributor (deposit record): ramadan

145 students, four five-point Likert blocks: AI awareness (AW1-AW6),
applied practice (AP1-AP8), perceived competence (PC1-PC6) and
attitudes/self-efficacy (AS1-AS8).

Q1-Q7 are open-ended Arabic free-text responses (120-135 distinct values
each), not scale items, and are dropped. The deposit's second file
codebook.csv carries item_text_arabic / item_text_english for every
variable and is a ready-made source for a future itemtext pass.
"""
...
DOI = "10.17632/xd27t4g547"
KEY = "xd27t4g547"
FILENAME = 'arabic_genai_competency_data.csv'
READ_KW = {}
UA = {"User-Agent": "irw-batch/1.0 (research)"}

TABLE_PREFIX = "ramadan_2026_"
BLOCKS = {'ai_awareness': 'AW\\d+', 'applied_practice': 'AP\\d+', 'perceived_competence': 'PC\\d+', 'attitudes': 'AS\\d+'}            # table suffix -> regex matching its item columns
COVS = {'study_level': 'cov_study_level', 'gpa': 'cov_gpa_band', 'prior_ai_training': 'cov_prior_ai_training', 'weekly_ai_use': 'cov_weekly_ai_use'}
DROP = ['participant_id', 'Q1', 'Q2', 'Q3', 'Q4', 'Q5', 'Q6', 'Q7']
DROP_REASON = 'open-ended Arabic free text / raw participant code, not a scale item'
SCALE = {'ai_awareness': (1, 5), 'applied_practice': (1, 5), 'perceived_competence': (1, 5), 'attitudes': (1, 5)}              # table suffix -> (min, max), or None to infer
QC_WAIVERS = {}
