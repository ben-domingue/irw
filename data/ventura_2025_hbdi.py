"""Herrmann Brain Dominance Instrument (HBDI), Peruvian university students.

DOI: 10.17632/wjsv27cc7v
Source: https://data.mendeley.com/datasets/wjsv27cc7v
License: CC BY 4.0
Contributor (deposit record): Ventura, Vertiz

578 respondents, 40 items on a 1-6 scale in the HBDI's four quadrant
blocks of ten (CA, CB, CC, CD). Each quadrant ships as its own table.
"""
...
DOI = "10.17632/wjsv27cc7v"
KEY = "wjsv27cc7v"
FILENAME = 'Propiedades psicométricas del test de Ned Herrmann, HBDI (Herrmann Brain Dominance Instrument, 1989).xlsx'
READ_KW = {}
UA = {"User-Agent": "irw-batch/1.0 (research)"}

TABLE_PREFIX = "ventura_2025_"
BLOCKS = {'quadrant_a': 'CA\\d+', 'quadrant_b': 'CB\\d+', 'quadrant_c': 'CC\\d+', 'quadrant_d': 'CD\\d+'}            # table suffix -> regex matching its item columns
COVS = {'Ciclo': 'cov_cycle', 'Tipo_colegio': 'cov_school_type', 'Carrera_profesional': 'cov_program', 'Genero': 'cov_gender', 'Rangodeedad': 'cov_age_band'}
DROP = []
DROP_REASON = ''
SCALE = {'quadrant_a': (1, 6), 'quadrant_b': (1, 6), 'quadrant_c': (1, 6), 'quadrant_d': (1, 6)}              # table suffix -> (min, max), or None to infer
QC_WAIVERS = {}
