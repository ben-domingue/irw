...
# efficacy. PLoS ONE.
#
# S1 Data (XLSX, N=240 Chinese pre-service teachers). Empathy dimension
# of Davis's (1996) Interpersonal Reactivity Index, 7 items, 7-point
# Likert (1-7; observed raw range 2-7). Companion scales from the same
# survey/sample: jiang_2025_sacie (15 items), jiang_2025_teaching_motivation
# (4 items), jiang_2025_inclusive_efficacy (18 items).
...
ITEM_COLS = [f"empathy{i}" for i in range(1, 8)]
