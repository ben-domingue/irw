...
def main() -> None:
    ...
    parts_split = long["item"].str.rsplit("_", n=2, expand=True)
    long["itemcov_pair"] = parts_split[0]
    long["itemcov_polarity"] = parts_split[2]
    long = long[["id", "item", "resp"] + id_vars[1:] + ["itemcov_pair", "itemcov_polarity"]]
