...
microdata <- vroom('DADOS/MICRODADOS_ENEM_2019.csv', 
                   delim=';', 
...
items <- vroom('DADOS/ITENS_PROVA_2019.csv', 
               delim=';',
...
df <- microdata |>
  ...
  # drop random string of 9s included in item keys
  mutate(TX_RESPOSTAS_LC = str_remove_all(TX_RESPOSTAS_LC, '9')) |>
...
save(df, file='enem_2019_1mil_lc.Rdata')
...
save(df, file='enem_2019_1mil_ch.Rdata')
...
save(df, file='enem_2019_1mil_cn.Rdata')
...
save(df, file='enem_2019_1mil_mt.Rdata')
