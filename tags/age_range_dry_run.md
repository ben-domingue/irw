...
| table | was | now |
|---|---|---|
| `colombia_2023_politics_voting` | `Mixed` | `Adult (18+)` |
| `mexico_2023_quality_wellbeingservice` | `Mixed` | `Adult (18+)` |
| `spain_2025_democracy_parties` | `Mixed` | `Adult (18+)` |
| `spain_2024_politics_beliefs` | `Mixed` | `Adult (18+)` |
| `margaretto_2025_translation_study_2_lextale` | `Mixed` | `Adult (18+)` |
| `silvia_2024_funny` | `Mixed` | `Adult (18+)` |
| `mexico_2023_quality_low` | `Mixed` | `Adult (18+)` |
