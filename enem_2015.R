...
microdata <- vroom('DADOS/MICRODADOS_ENEM_2015.csv', 
                   delim=';', 
...
items <- vroom('DADOS/ITENS_PROVA_2015.csv', 
               delim=';',
...
save(df, file='enem_2015_1mil_ch.Rdata')
...
save(df, file='enem_2015_1mil_cn.Rdata')
...
save(df, file='enem_2015_1mil_lc.Rdata')
...
save(df, file='enem_2015_1mil_mt.Rdata')
