...
if st.session_state.documentation_page:
    ...
    with col2:
        st.video("https://www.youtube.com/watch?v=dQw4w9WgXcQ")  # Replace with any valid video URL
...
with tab7:
    ...
    rating = st.slider("Rate the tool", 0, 5)
    ...
    if st.session_state.feedback_response == "No":
        ...
        data_link = st.text_input("Link to your dataset", placeholder="Paste the dataset link here")
        ...
        if st.button("Submit Feedback"):
            if data_link and comments:
                st.success("Thank you for your feedback! We’ll review it and improve the tool.")
            else:
