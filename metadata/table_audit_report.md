# IRW table-name consistency audit -- 2026-09-04
...
Full list, aligned columns: `table_audit_report_incomplete.txt`. Same data as CSV: `table_audit_report_incomplete.csv` (148 rows). Nothing here is auto-fixed -- triage by hand.
...
| autobiographicalinterview_lockrow_2023_selfreport | core |  | 1 | 1 |  |  |
| canham l, salamh p et al. (2018). evaluation of non-cognitive traits of doctor of physical therapy learners in the united states. harvard dataverse. | core |  | 1 | 1 |  |  |
| colombia_2023_politics_network | core |  | 1 | 1 |  |  |
| dicarlo_2026_attentioncontrol_acd | core | 1 |  |  | 1 |  |
| dicarlo_2026_attentioncontrol_acs | core | 1 |  |  | 1 |  |
| dicarlo_2026_attentioncontrol_arces | core | 1 |  |  | 1 |  |
| dicarlo_2026_attentioncontrol_maaslo | core | 1 |  |  | 1 |  |
| eammi_grahe_2018_marriage_timing | core |  | 1 | 1 |  |  |
_...and 118 more, see the .txt or .csv._
